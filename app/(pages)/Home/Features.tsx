...
const features = [
    ...
    },
    {
        ...
        description: "Control visibility—keep images private or share them on the Feed.",
    ...
    {
        title: "Secure Access",
        description: "Log in to access your profile and ensure your content is secure.",
  ...
  export default function Features() {
    return (
      <section className='flex flex-col justify-center items-center py-12'>
        ...
        <h2 className='text-3xl lg:text-4xl font-bold tracking-wide mb-8'>Our Features</h2>
